...
function regularExpressionMatchArrayRoutes(string $uri, array $routes)
{
    return array_filter(
        $routes,
...
function params(array $uri, array $matchedUri):array
{
    if (!empty($matchedUri)) {
...
function paramsFormat(array $uri, array $params):array
{
    $paramsData = [];
